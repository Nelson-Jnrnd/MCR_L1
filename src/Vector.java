...
public class Vector {
    ...
    public Vector multiply(double factor){
        return new Vector((int)Math.round(factor * i), (int)Math.round(factor * j));
    }
    ...
    public Vector reflectionAcrossLine(Vector line){ // TODO fix
        Vector v = line.multiply(2 * crossProduct(line) / Math.pow(line.norm(), 2));
        return v.sub(this);
    }
